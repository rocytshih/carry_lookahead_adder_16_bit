...
HD_PWD='C:/Users/User/Desktop/CloudStation/LAB/LAB1/LAB1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log carry_lookahead_adder_16_bit_2_level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source carry_lookahead_adder_16_bit_2_level.tcl
